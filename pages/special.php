...
<h1 class="singlehed">Special Report Archives</h1>
...
$query_string = 'category_name=Special Report';
...
<div style="font-size: 16px; margin-bottom: 20px;">
	<a href="<?php bloginfo('url'); ?>/special-reports-by-month/" style="color: #6F7072; text-decoration: none;">More archived special reports</a>
