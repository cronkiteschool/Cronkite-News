 ...
 * Template Name: Ajax w/ Stripped Content
*/
?>

<div style="background: #D0D1E5; width: 592px; height: 20px; line-height: 20px; padding-left: 10px; margin-bottom: 10px; margin-top: 10px; font-weight: bold;">
...
<div id="props">
	...
	<div class="passed">
        <a href="#"><div class="prop_num">106: </div>
        <div class="slug">Health Care</div></a>
    </div>

    <div class="passed">
        <a href="#"><div class="prop_num">107: </div>
        <div class="slug">Affirmative Action</div></a>
    </div>

    <div class="failed">
        <a href="#"><div class="prop_num">109: </div>
        <div class="slug">Hunting Rights</div></a>
    </div>

    <div class="prop_box">
       <a href="#"> <div class="prop_num">110: </div>
    ...
    <div class="prop_box">
        <a href="#"><div class="prop_num">112: </div>
    ...
    <div class="prop_box">
        <a href="#"><div class="prop_num">203: </div>
        <div class="slug">Medical Marijuana</div></a>
    </div>

    <div class="failed">
        <a href="#"><div class="prop_num">301: </div>
        <div class="slug">Conservation Fund</div></a>
    </div>

    <div class="failed">
        <a href="#"><div class="prop_num">302: </div>
