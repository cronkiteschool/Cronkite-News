...
<!--<script language="JavaScript" type="text/javascript">
QT_WriteOBJECT_XHTML('http://cronkitenews.jmc.asu.edu/assets/video/poster/2010election_poster2.jpg', '270', '202', '',
  'type', 'video/quicktime',
    ...
    'scale', 'tofit',
    'target', 'myself',
    'qtsrc', 'http://cronkitenews.jmc.asu.edu/assets/video/special/newswatch.mov'
  	); 
</script>
-->
